...
def parse_file():
    ...
    #print('number of indiced columns', colnum)
    #
        ...
        try:
            with open(i, 'rb') as f:
                ...
                for line in contents():
                    ...
                    #print('length of new parsed data',len(new_parsed_data))
                    #print("*************")
    ...
    print("script ran succesfully, vasikomulty.xls created")
        #print(new_parsed_data)
